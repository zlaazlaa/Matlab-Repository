...
[Best_score,Best_pos,GWO_cg_curve]=GWO(SearchAgents_no,Max_iteration,lb,ub,dim,fobj,0);
[my_Best_score,my_Best_pos,my_GWO_cg_curve]=GWO(SearchAgents_no,Max_iteration,lb,ub,dim,fobj,1);
