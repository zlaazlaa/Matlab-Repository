function varargout = DA_toolbox(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @DA_toolbox_OpeningFcn, ...
                   'gui_OutputFcn',  @DA_toolbox_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before DA_toolbox is made visible.
function DA_toolbox_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to DA_toolbox (see VARARGIN)

% Choose default command line output for DA_toolbox
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes DA_toolbox wait for user response (see UIRESUME)
...
function varargout = DA_toolbox_OutputFcn(hObject, eventdata, handles) 
...
cbStr = 'web(''http://dx.doi.org/10.1007/s00521-015-1920-1'');';
